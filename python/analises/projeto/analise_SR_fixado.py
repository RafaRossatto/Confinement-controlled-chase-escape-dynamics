...
from utils.leitura import carregar_dataframes_com_runs
from utils.plotagem import plotar_curvas_media_e_desvio
...
O = 0
chaves_escolhidas = [
    "SR_TCC_5_SR_TCT_5", "SR_TCC_10_SR_TCT_5", "SR_TCC_15_SR_TCT_5",
